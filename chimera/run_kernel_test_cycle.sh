...
python chimera/py/setup_surface_kernel_py.py --kernel-version "6.8.1" --surface-archive-tag "arch-6.8.1-1" --output-name "linux-surface-generated" --force # Path relative to project root
